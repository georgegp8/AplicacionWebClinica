...
<body class="bg-cover bg-center min-h-screen flex flex-col" style="background-image: url('{{ asset('images/horarios/horarios.webp') }}'); background-repeat: no-repeat; background-size: cover; background-position: center;">
    ...
    $nextTick(() => {
        ...
        <div x-show="loading" class="loader fixed inset-0 flex justify-center items-center bg-teal-700 z-50"
            ...
            <!-- Fondo temporal detrás del loader -->
            <div class="absolute inset-0 bg-teal-700"></div>

            <!-- Animación del logo -->
            <svg class="h-[160px] w-[210px] stroke-[0.4px] stroke-white fill-none relative z-10" viewBox="0 0 51 50"
        ...
        <div x-show="content" x-cloak x-transition:enter="transition ease-in-out duration-500"
            x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" class="flex flex-col flex-grow">
            ...
            <main class="flex-grow">
                <div class="w-full p-6">
                    ...
                    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg border bg-opacity-90">
                        ...
                        <!-- Ajustar el ancho del contenedor secundario -->
                        <div class="p-6 bg-white shadow-md rounded-lg border">
                            <div id="consultorio_info" class="text-gray-600 text-sm overflow-auto">
