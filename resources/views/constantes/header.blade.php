 ...
 <div x-data="{ isMenuOpen: false, isServicesOpen: false , isResultOpen:false ,isReservasOpen:false , isSubMenuOpen: false, isSubMenuROpen: false ,isSubMenuREOpen : false   }" 
     x-init="window.addEventListener('resize', () => {
        if (window.innerWidth > 1370) {
                    ...
                    <ul class="flex justify-around items-center w-full max-xl:justify-between max-xl:px-4 max-md:justify-between">
                        ...
                        <div class="max-xl:flex max-xl:items-center max-xl:gap-x-4 max-md:gap-x-2">
                            ...
                            <li class="cursor-pointer hidden max-xl:flex max-xl:items-center flex-wrap">
                                <button class="h-10 " @click="isMenuOpen = !isMenuOpen ; isSubMenuOpen = false; isSubMenuROpen = false ; isSubMenuREOpen = false" >
            ...
            <div 
            x-show="isMenuOpen"
            x-init="$watch('isMenuOpen', value => { if (!value) { isSubMenuOpen = false; isSubMenuROpen = false; isSubMenuREOpen = false; } })"
        ...
        >
            <ul class="max-xl:w-11/12 flex justify-end max-sm:w-[95.9%]" >
                <div class="w-[255px] py-2 gap-y-3 h-auto content-around flex pl-4 flex-wrap bg-white max-sm:w-[200px] backdrop-blur-md" x-data="{}"  >
                    ...
                    <li class="text-gray-700 hover:text-gray-500 text-lg w-full" 
                        ...
                        <ul 
                            :class="isSubMenuOpen ? 'menu-expanded menu-transition' : 'menu-collapsed menu-transition_leave'"
                            class="pl-4">
                    ...
                    <li class="text-gray-700 hover:text-gray-500 text-lg w-full" 
                        ...
                        <ul 
                            :class="isSubMenuROpen ? 'menu-expanded menu-transition' : 'menu-collapsed menu-transition_leave'"
                            class="pl-4">
                            <li class="text-gray-700 hover:text-gray-500 text-lg"><a href="/resultados/cirugias">Cirugías</a></li>
                            <li class="text-gray-700 hover:text-gray-500 text-lg"><a href="/resultados/tratamientos">Tratamientos</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="text-gray-700 hover:text-gray-500 text-lg w-full" 
                        ...
                        <ul 
                            :class="isSubMenuREOpen ? 'menu-expanded menu-transition' : 'menu-collapsed menu-transition_leave'"
                            class="pl-4">
                            <li class="text-gray-700 hover:text-gray-500 text-lg"><a href="/reservas/cita">Solicitar Cita</a></li>
