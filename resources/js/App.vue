<template>
  <div class="wrapper " id="app">
    <div
      class=" max-xl:w-[570px]  w-[100%]   flex flex-wrap justify-center items-center  bg-white  p-10 rounded-xl gap-x-10 max-md:w-[500px] max-sm:w-[450px] max-sm:p-5">
      ...
      <div class="_inner ">
          ...
          <!-- inputs -->
          <button class="card-form__button bg-teal-500" type="submit" id="submitBtn">
            Pagar
          </button>
         <!-- boton -->
