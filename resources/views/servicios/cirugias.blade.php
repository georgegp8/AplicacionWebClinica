...
<div class="h-[500px]  w-full bg-cover bg-center relative" style="background-image: url('{{ asset('images/servicios/cirugias/back.webp') }}');">
...
@foreach ($cirugias as $index => $cirugia)
    @if ($index % 2 === 0)
        ...
        <div class="h-[400px]  flex justify-between">
            ...
            <div class="w-1/2 h-full bg-cover bg-center" style="background-image: url('{{ asset('images/servicios/cirugias/' . $cirugia->imagen) }}');">
            </div>
        </div>
    @else
        <!-- Estructura de Div 2 -->
