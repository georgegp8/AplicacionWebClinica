...
@section('content')
    <div class="w-full max-w-4xl bg-white p-6 rounded-lg shadow-md">
        ...
        <p class="text-center text-gray-600 mt-2 max-md:text-[13px]">
            Para poder registrar tus datos y solicitar una cita online necesitas llenar el siguiente formulario. Te
            enviaremos el costo e información necesaria para completar el proceso a tu email.
        </p>
        ...
        <form method="POST" action="{{ route('reserva.cita') }}" class="mt-4 space-y-4" id="citaForm">
            ...
            <!-- Botón de envío -->
            <button type="submit"
                class="w-full py-3 mt-4 bg-teal-500 text-white rounded-lg hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-blue-200">
                Solicitar cita
            </button>
        </form>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            servicioSelect.addEventListener("change", () => {
                ...
                if (procedimientos[servicio]) {
                    procedimientos[servicio].forEach(({
                        nombre,
                        costo
                    }) => {
            ...
            `;
                        ...
                        procedureDiv.addEventListener("click", () => {
                            ...
                            const allProcedures = document.querySelectorAll(
                                ".procedure-selected");
