...
<head>
    ...
    {{-- Favicon --}}
    <link rel="icon" type="image/svg+xml" href="{{ asset('favicon/logo1.svg') }}">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="" class="brand-link">
                <img src="{{ url('images/svg/logo1.svg') }}" alt="AdminLTE Logo"
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @can('admin.usuarios.index')
                            {{-- Restringir vista --}}
                            {{--         Navegación Configuraciones       --}}
                            <li class="nav-item">
                                <a href="{{url('/admin/configuraciones')}}" class="nav-link active">
                                    <i class="nav-icon fas bi bi bi-gear"></i>
                                    <p>
                                        Configuraciones
                                    </p>
                                </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2024 <a href="https://adminlte.io">CitasTEC</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
