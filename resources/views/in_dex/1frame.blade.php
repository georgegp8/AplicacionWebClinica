            ...
            <div class="flex h-[85%]  flex-wrap   ">
                                ...
                                <div class="">
                                    <div class="mt-4 gap-y-4 flex h-[300px] flex-wrap overflow-hidden ">
                                        @foreach ($tratamientos as $tratamiento)
                                            <div class="bg-teal-500 h-[220px]  pt-5 px-4 w-full animate-indextratamiento max-sm:h-[170px] max-sm:animate-indextratamientoSM">
                                ...
                                <div>
                                    <div class="mt-4 gap-y-4  flex h-[300px] flex-wrap overflow-hidden">
                                        @foreach ($cirugias as $cirugia)
                                            <div class="bg-teal-500 h-[220px] pt-5 px-4 w-full animate-indexcirugia max-sm:h-[170px] max-sm:animate-indexcirugiaSM">
                ...
                <div class="w-1/2  h-full max-xl:w-full max-xl:h-1/2 flex justify-center items-center  max-sm:h-auto max-sm:py-10 frame"  >
                    <div class="w-10/12   max-xl:backdrop-blur-3xl max-xl:bg-teal-500/50 max-xl:bg-opacity-20 max-xl:p-3 hidden-element">
                        ...
                        <p class="mt-4 text-white text-[17px]
                        max-md:mt-2
                        max-md:text-[15px]"> 
