                                                ...
                                                function cargarHorarios(consultorio_id) {
                                                    $.ajax({
                                                        ...
                                                        error: function() {
                                                            ...
                                                            '<p>Error al cargar los datos del consultorio.</p>');
                                                        }
                                                    });
                                                }
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="hora_inicio"
                                            value="{{ old('hora_inicio', $horario->hora_inicio) }}" class="form-control"
                                            required>
                                        @error('hora_inicio')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="hora_final"
                                            value="{{ old('hora_final', $horario->hora_final) }}" class="form-control"
                                            required>
                                        @error('hora_final')
                                            <small style="color:red">{{ $message }}</small>
                                        @enderror
