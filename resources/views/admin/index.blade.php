...
@section('content')
    ...
    @can('admin.usuarios.index') {{-- Restringir acceso --}}
    ...
    @can('admin.secretarias.index') {{-- Restringir acceso --}}
    ...
    @can('admin.pacientes.index') {{-- Restringir acceso --}}
    ...
    @can('admin.consultorios.index') {{-- Restringir acceso --}}
    ...
    @can('admin.doctores.index') {{-- Restringir acceso --}}
