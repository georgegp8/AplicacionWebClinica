...
data-bg="url('{{ asset('images/index_img/2frame/back.webp') }}')"> 
        <div class="w-full h-full bg-gradient-to-t from-teal-100 via-transparent to-gray-100 flex flex-wrap max-xl:justify-center max-xl:items-center">
            ...
            <div class="w-1/2  h-full max-xl:w-full max-xl:h-1/2 flex justify-center items-center ">
                <div class="h-3/4 w-3/4  flex items-center">
                    <div>
                        ...
                        <div class="w-full flex justify-center max-xl:mt-4">
                            <div class=" bg-teal-600 w-40 h-10 flex justify-center items-center hover:bg-teal-500 ease-in delay-100 duration-75   text-lg max-md:text-[17px]  max-md:w-[150px] text-white ">
                                <a href="/nosotros" class=" text-[14px]">Sobre Nosotros</a>
                            </div>
                        </div>
                    </div>
            </div>
