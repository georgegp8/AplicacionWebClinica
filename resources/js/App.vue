<template>
  <div class="wrapper " id="app">
    <div
      class=" max-xl:w-[570px] m-auto w-[100%]   flex flex-wrap justify-center items-center  bg-white  p-10 rounded-xl gap-x-10 max-md:w-[500px] max-sm:w-[450px] max-sm:p-5">

      <!-- form -->
      <div class="_inner ">
        <div class="card-input">
          <label for="clave_pago" class="card-input__label">Clave de pago</label>
          <input type="text" id="clave_pago" class="card-input__input" @focus="focusInput" @blur="blurInput" data-ref=""
            autocomplete="off">
        </div>
        <div class="card-input">
        ...
        <!-- inputs -->
        <button class="card-form__button bg-teal-500">
          Submit
        </button>
        <!-- boton -->
          ...
          <div class="card-item__side -front">
            ...
            <div class="card-item__cover">
              <img
                ...
                class="card-item__bg " loading="lazy">
            </div>
