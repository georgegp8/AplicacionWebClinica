<div x-data="{ isMenuOpen: false, isServicesOpen: false, isResultOpen: false }" x-init="window.addEventListener('resize', () => {
    ...
    <nav class="flex flex-wrap h-[140px] justify-center items-end max-xl:h-[140px] " id="frame3">
        <div
            class="border-l-4 border-teal-800 bg-white h-[80px] w-10/12 flex items-center max-sm:w-11/12  backdrop-blur-md hidden-element">
            <ul
                class="flex justify-around items-center w-full max-xl:justify-between max-xl:px-4 max-md:justify-between">
                <li>
                    <div class="w-60 h-12 flex items-center justify-center max-sm:w-[180px] max-sm:justify-start">
                        <svg class="w-12 max-sm:w-10" viewBox="0 0 51 50" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path class="fill-teal-300"
                        ...
                        <span
                            class="h-12 flex items-center border-l-2 border-teal-200 pl-4 ml-4 max-sm:h-10 max-sm:ml-2 max-sm:pl-2">
                ...
                <div class="max-xl:flex max-xl:items-center max-xl:gap-x-4 max-md:gap-x-2">
                    <li
                        class="max-xl:hidden bg-teal-300 w-40 h-12 flex justify-center items-center hover:bg-teal-200 delay-200 duration-75 text-gray-700 hover:text-gray-500 text-lg">
                    ...
                    <li class="cursor-pointer hidden max-xl:flex max-xl:items-center flex-wrap">
                        <button class="h-10 " @click="isMenuOpen = !isMenuOpen">
                            ...
                            <svg x-show="isMenuOpen" class="h-10 w-10 stroke-teal-800 max-md:h-8" viewBox="0 0 14 14"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M2 2L12 12M2 12L12 2" stroke-width="2.5" stroke-linecap="round"
