<div class="h-screen w-full bg-white opacity-100 relative  max-sm:h-auto max-sm:py-10" >
        ...
        <div class="h-[80%]  flex max-sm:flex-col max-sm:justify-center max-sm:items-center max-sm:gap-y-4">
            <div class="w-[50%] h-full  flex justify-center items-center max-sm:w-auto ">
                <div class="w-[75%] ">
            ...
            <div class="w-[50%] h-full flex justify-center items-center max-sm:w-auto ">
                <div class="w-[450px] h-[450px]   rounded-full flex justify-center items-end bg-teal-100 bg-opacity-75 max-md:w-[400px] max-md:h-[400px]">
        ...
        <!-- numeros -->
        <div class="h-[15%]  flex justify-center     max-sm:mt-8 max-sm:h-auto ">


            <div class="flex items-center w-10/12    max-sm:flex-wrap justify-center max-sm:gap-y-5 ">
