				...
				<table id="example1" class="table table-striped table-bordered table-hover table-sm">
					...
					@foreach ($horarios as $horario)
						<tr>
							...
							<td style="text-align: center">{{$horario->hora_final}}</td>
							<td style="text-align: center">
								<div class="btn-group" role="group" aria-label="Basic example">
									<a href="{{url('admin/horarios/'.$horario->id)}}" type="button" class="btn btn-info btn-sm"><i class="bi bi-eye"></i></a>
									<a href="{{url('admin/horarios/'.$horario->id.'/edit')}}" type="button" class="btn btn-warning btn-sm"><i class="bi bi-pencil"></i></a>
